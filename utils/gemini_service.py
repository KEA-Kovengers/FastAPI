...
# def extract_text_inside_curly_braces(s):
#     start_index = s.find('{')
#     end_index = s.find('}') + 1
#     if start_index != -1 and end_index != -1:
#         substring = s[start_index:end_index]
#         print("추출된 substring:", substring)
#         return substring
#     else:
#         print("'{substring}'를 찾지 못했습니다.")
#         return ""
...
#     5. Speak in Korean.
#     6. Number of hashtags should be under the 5.
...
#     print(response.text)
#     print('----')
#     extracted_text = extract_text_inside_curly_braces(response.text)
#     print(extracted_text)
    
#     # Returning the text response from the model
#     return extracted_text.replace('```json', '').replace('```', '')
...
#     5. The summarized blog content should not exceed a maximum of 500 characters.
